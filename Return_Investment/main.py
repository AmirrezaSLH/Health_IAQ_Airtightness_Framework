...
test = init_PM_Concentrations_means()

def sample_pm(pm_full_dict):
    
    year = random.randint(1981, 2010)
    
    pm_dict = pm_full_dict[str(year)]
...
def run_MCS(intervention_function = intervention_calculator, HF = 'HF_3', rr_beta = 0.005826891, rr_beta_sd = 0.000962763, iterations = 10):
    pm_full_dict = init_PM_Concentrations_means()
    ...
    for n in range(iterations):
        ...
        pm_dict = sample_pm(pm_full_dict)
        #pm_dict = pm_full_dict[year]
