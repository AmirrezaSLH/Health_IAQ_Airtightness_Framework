...
def plot_scatter_comparison(data_lists, labels, colors, plot_title='Scatter Plot', x_label='PM2.5', y_label='Benefits'):
    """
    ...
    # Check if the length of labels and colors match the data lists
    if len(data_lists) != len(labels) or len(data_lists) != len(colors):
        raise ValueError("Length of data_lists, labels, and colors must match.")
...
# Example usage
list1 = [(10, 100), (15, 110), (20, 120)]
list2 = [(25, 130), (30, 140), (35, 150)]
list3 = [(40, 160), (45, 170), (50, 180)]

data_lists = [list1, list2, list3]
labels = ['List 1', 'List 2', 'List 3']
colors = ['red', 'blue', 'green']

plot_scatter_comparison(data_lists, labels, colors, plot_title='Benefits vs PM2.5 Comparison')
...
def create_contour_plot(gdf, data, tc, title='', legend_label='', legend_ticks=None, color = 'red'):
    ...
    if color == 'custom':
        ...
        range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['white', 'steelblue'])
    elif color == 'red':
        range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['white', 'red'])
        #range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['white', 'white'])
...
def create_contour_plot_negetive(gdf, data, tc, title='', legend_label='', legend_ticks=None, color = 'red'):
    ...
    contour = ax.contourf(grid_x, grid_y, grid_z_masked, levels=np.linspace(z.min(), -z.min(), 1000), cmap=range_cmap, alpha=0.9)
    #contour = ax.contourf(grid_x, grid_y, grid_z_masked, levels=np.linspace(-6000, 6000, 1000), cmap=range_cmap, alpha=0.9)
    #fig.colorbar(contour, ax=ax, label='Net Benefits')
    ...
    #new_ticks = [  -5000, -3000, -1000, 0, 1000, 3000, 5000]
    #new_ticks = [  -6000, -4000, -2000, 0, 2000, 4000, 6000]
    #new_ticks = [  -4000, -3000, -2000,-1000, 0,1000, 2000, 3000, 4000]
    
    #new_ticks = [  -2000, -1000, 0, 1000, 2000]
    #new_ticks = [  -1200, -800, -400, 0, 400, 800, 1200]
...
def create_contour_plot_dy(gdf, data, tc, title='', legend_label='', legend_ticks=None, color = 'red'):
    ...
    if color == 'red':
        ...
        range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['white', 'seagreen'])
    elif color == 'blue':
        range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['white', 'blue'])
...
def create_contour_plot_ach_reduction(gdf, data, tc, title='', legend_label='', legend_ticks=None, color = 'red'):
    ...
    if color == 'red':
        ...
        range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['#FFFF00', '#4B0082'])
        #range_cmap = LinearSegmentedColormap.from_list('white_to_red', ['#FFFF00', '#B22222'])
